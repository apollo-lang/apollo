...
short = Duration 16
long = Duration 64
superlong = Duration 16
r1 = Rest superlong
r2 = AtomRest r1
n1 = AtomNote (Note sol short)
n2 = AtomNote (Note mib long)
p1 = Part [r2, n1, r2, n1, n1, n1, n2, c2, r2, n1]
main = Music [p1] -- Beethoven's Symphony No. 5

c1 = AtomChord (Chord [sol, mib] long)
c2 = AtomChord (Chord [doe, mib, sol] (Duration 64))
c3 = Chord [doe, mib, sol] long
p2 = Part [c1, r2, n1]
m1 = Music [p1, p2]
